...
`.trim();
export const PRODUCT_DECK_STYLE_TAG = `<style id="${PRODUCT_DECK_STYLE_ID}">\n${PRODUCT_DECK_BASE_CSS}\n</style>`;
...
export function injectProductDeckShell(html) {
    let out = html;
...
export function productDeckLayoutPromptLines() {
    return [

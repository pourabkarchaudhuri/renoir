...
export function computePromptHash(prompt, size, quality) {
...
function lookupCache(projectId, promptHash) {
...
function insertCache(projectId, entry) {
    const cache = getCache(projectId);
...
export function getCacheForProject(projectId) {
...
function broadcastProgress(completed, total, itemId, ok) {
    try {
...
export async function batchGenerateImages(req) {
...
async function generateSingle(item, size, quality, promptHash, projectId, semaphore) {

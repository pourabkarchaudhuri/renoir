...
function mimeFromPath(filePath, data) {
...
function resolveRenoirAssetPath(src, workspaceRoot) {
...
export async function fetchExportImage(src, workspaceRoot) {
    if (!src)
        return null;
...
export function createImageFetcher(workspaceRoot) {
    return async (src) => {
